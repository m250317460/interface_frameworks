...
Innovation::Innovation(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Innovation)
{
    ui->setupUi(this);
...
void Innovation::on_add_clicked()
{
...
void Innovation::on_del_clicked()
{
...
void Innovation::on_modify_clicked()
{
...
void Innovation::on_btn_import_clicked()
{
...
void Innovation::on_btn_output_clicked()
{
    QXlsx::Document xlsx;
    QString value;
