...
#include "ui_construction_plan.h"

#include <QFile>
#include <QTextStream>
#include "qdebug.h"

Construction_plan::Construction_plan(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Construction_plan)
{
    ui->setupUi(this);
...
//    ui->tableWidget->setRowCount(4);
    ...
    header << "方案名称" << "编制部门" << "编制人" << "审核状态"<<"操作时间"<<"操作人"<<"备注"<<"操作";
...
void Construction_plan::on_add_clicked()
{
...
void Construction_plan::on_del_clicked()
{
...
void Construction_plan::on_modify_clicked()
{
...
void Construction_plan::on_btn_import_clicked()
{
...
void Construction_plan::on_btn_output_clicked()
{
    QXlsx::Document xlsx;
    QString value;
