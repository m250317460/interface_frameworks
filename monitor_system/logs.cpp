...
//    ui->tableWidget->setRowCount(4);
    ...
    header << "部门" << "设备名称" << "规格型号" << "使用地点"<<"使用开始时间"<<"使用结束时间"<<"操作时间"<<"操作人";
...
void logs::on_btn_import_clicked()
{
...
void logs::on_btn_output_clicked()
{
    QXlsx::Document xlsx;
    QString value;
