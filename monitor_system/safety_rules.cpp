...
#include "ui_safety_rules.h"

#include <QFile>
#include <QTextStream>
#include "qdebug.h"

Safety_rules::Safety_rules(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Safety_rules)
{
    ui->setupUi(this);
...
//    ui->tableWidget->setRowCount(4);
    ...
    header << "安全工作计划名称" << "计划开始时间" << "计划结束时间" << "内容摘要"<<"操作日期"<<"操作人";
...
void Safety_rules::on_add_clicked()
{
...
void Safety_rules::on_del_clicked()
{
...
void Safety_rules::on_modify_clicked()
{
...
void Safety_rules::on_btn_import_clicked()
{
...
void Safety_rules::on_btn_output_clicked()
{
    QXlsx::Document xlsx;
    QString value;
