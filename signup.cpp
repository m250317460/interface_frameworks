...
//    ui->tableWidget->setRowCount(4);
    ...
    header << "部门" << "设备名称" << "规格型号" << "使用地点"<<"安装单位"<<"验收情况"<<"操作时间"<<"操作人";
...
void Signup::on_btn_import_clicked()
{
...
void Signup::on_btn_output_clicked()
{
    QXlsx::Document xlsx;
    QString value;
